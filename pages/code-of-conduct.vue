    ...
    <div class="hero is-dark has-orange-border-bottom">
      <div class="hero-body">
        <div class="container has-text-centered has-text-weight-light">
          <h1 class="title is-1 has-text-weight-light">Code of Conduct.</h1>
        </div>
      </div>
    </div>
      ...
      <div class="hero-body">
        <div class="container has-text-weight-light">
          <div class="content">
            ...
            <!-- Pledge -->
            <h2 class="subtitle">Our Pledge</h2>
            ...
            <!-- Standards -->
            <h2 class="subtitle">Our Standards</h2>
            <p>
            ...
            <h2 class="subtitle">Enforcement Responsibilities</h2>
            <p>
            ...
            <!-- Enforcement -->
            <h2 class="subtitle">Enforcement</h2>
            <p>
              Instances of abusive, harassing, or otherwise unacceptable
              behavior may be reported to the community leaders responsible for
              enforcement at info@feirm.com. All complaints will be reviewed and
            ...
            <h2 class="subtitle">Enforcement Guidelines</h2>
            <p>
            ...
            <!-- Attribution -->
            <h2 class="subtitle">Attribution</h2>
            <p>
            ...
            <a href="https://www.contributor-covenant.org">Homepage</a>
          </div>
        </div>
      </div>
    </div>
